...
public class RoomNetworked : NetworkBehaviour
{
    ...
    //TODO: Some of these may need to be SyncVar
    //TODO: Should these be local values?
    ...
    //readonly SyncListFloat collisionValues = new SyncListFloat();
    ...
    public void setCollisionValues()
    {
        ...
        for (int i = 0; i < numCollisions; i++)
        {
            ...
            collisionValues[baseIndex + 7] = Mathf.Max(0.0f, min);
        }
